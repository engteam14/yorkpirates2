...
class QueueFIFOTest {
    ...
    void add() {
        ...
        assertAll(() -> assertEquals(new ArrayList<>(Arrays.asList(1,2,3,4)), queue3.get(), "Adding values failed" ),
                () -> assertEquals( new ArrayList<>(Arrays.asList(1)), queue0.get(), "Adding value to empty array failed"));
    }
    ...
    void remove() {
        ...
        assertAll(() -> assertTrue(queue3.remove(x), "Can't remove a value when present")
                ...
                , () -> assertEquals(queue0.get(), new ArrayList<>(), "Array is not the same after an unsuccessful remove due to empty array")
    ...
    void removeAll() {
        ...
        assertAll(() -> assertFalse(queue0.removeAll(toRemove))
                ...
                , () -> assertEquals(new ArrayList<>(Arrays.asList(2)), queue3.get())
    ...
    void retainAll() {
        ...
        queue6.set(new ArrayList<Object>(Arrays.asList(1,2,3,4,5,5)));
